...
const ENUM_STATUSES = {
  ...
  error: <ExclamationCircleIcon className="w-7 text-[#ff0000]" />,
...
const Notification = ({
  ...
  return toast.custom(
    t => (
      <div
        className={`flex flex-row items-start justify-between max-w-sm bg-base-100 p-4 transform-gpu relative transition-all duration-500 ease-in-out space-x-2 border-2 rounded-none border-black
        ${
